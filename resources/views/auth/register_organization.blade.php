...
<div class="container flex flex-col mt-20 max-w-lg border border-dark p-10 rounded-md">
    ...
    <div class="">
        <span class="text-2xl font-poppins font-medium">Sign Up your organization account</span>
    </div>
    <form class="pt-8" method="POST">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <label for="floating_name" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-accent duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-accent peer-focus:dark:text-accent peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Organization Name</label>
        </div>
