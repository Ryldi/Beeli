...
<div class="container flex flex-col mt-20 max-w-lg border border-dark p-10 rounded-md">
    ...
    <div class="">
        <span class="text-2xl font-poppins font-medium">Login with organization account</span>
    </div>
...
<div class="flex flex-col items-center pt-10">
    <a href="{{ route('login_personal.view') }}" class="text-secondary hover:text-gray-500 transition-all duration-500">Login to your personal account</a>
