...
<div class="container mx-auto mt-40 px-14">
    <div class="flex flex-col mb-10 md:mb-0 md:flex-row justify-between">
    ...
    <div class="grid place-content-end mb-24 mt-6">
        <form action="{{ route('cart.checkout') }}" method="POST">
            ...
            <button type="submit" class="px-4 py-1 bg-accent text-white rounded-lg hover:bg-white hover:text-accent hover:border hover:border-accent transition-all duration-500" onclick="prepareSelectedProducts()">
                Checkout
            </button>
        </form>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-4 flex justify-center">
        <h3 class="font-semibold text-lg">No items in cart yet</h3>
    </div>
    @endif
</div>
